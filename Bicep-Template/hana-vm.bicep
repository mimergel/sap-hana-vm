...
param hanaSystemSize string = 'E16ds_v4_128_GB'
...
var sizes = {
  E16ds_v4_128_GB: {
    HANA: {
      ...
      scriptArguments: {
        Linux: '-luns \'0#1,2#3#4\' -names \'usrsap#data#log#shared\' -paths \'/usr/sap#/hana/data#/hana/log#/hana/shared\' -sizes \'100#100#100#100\''
      }
      useFastNetwork: true
    }
  }
  E20ds_v4_160_GB: {
    HANA: {
      ...
      scriptArguments: {
        Linux: '-luns \'0#1,2,3,#4#5\' -names \'usrsap#data#log#shared\' -paths \'/usr/sap#/hana/data#/hana/log#/hana/shared\' -sizes \'100#100#100#100\''
      }
      useFastNetwork: true
    }
  }
  ...
  M32ts_192_GB: {
    HANA: {
      ...
      scriptArguments: {
        Linux: '-luns \'0#1,2,3,4#5,6,7#8\' -names \'usrsap#data#log#shared\' -paths \'/usr/sap#/hana/data#/hana/log#/hana/shared\' -sizes \'100#100#100#100\''
      }
      useFastNetwork: true
    }
  }
    ...
    ipConfigurations: [
      {
        ...
        properties: {
          ...
          subnet: {
            id: subnetID //resourceId('Microsoft.Network/virtualNetworks/subnets', vnetName, subnetName)
          }
        }
      }
    ]
...
resource vmName_csExtension_internalOSType_Name 'Microsoft.Compute/virtualMachines/extensions@2021-07-01' = {
  parent: vmName
